...
:::{.column width=0.25 .profile-sidebar}

::: {.profile-card}
![](images/profile.jpg){.profile-photo fig-alt="Ebenezer O. Makinde"}

<div class="profile-name">Ebenezer O. Makinde</div>
